...
import { QrCode, ArrowRight } from "lucide-react-native";
								...
								<View style={styles.userInfoContainer}>
									<View style={styles.userTextContainer}>
										...
										<ThemedText
											...
											darkColor={
												username ? Colors.dirtyWhite : Colors.almostWhite
											}
										>
											{truncatedPublicKey}
										</ThemedText>
						...
						<View style={styles.welcomeContainer}>
							<View style={styles.welcomeCard}>
								...
								<ThemedText
									...
									lightColor={Colors.darkGray}
								>
									Get started by scanning a QR code to log in to a website or
									make a payment.
								</ThemedText>
